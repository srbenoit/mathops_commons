...
/**
 * A comment node, used to represent the content of a comment.
 */
public final class Comment extends CharSpan implements IContentNode {
     ...
     */
    Comment(final XmlContent xml, final int theStart, final int theEnd, final int theLineNumber, final int theColumn) {
